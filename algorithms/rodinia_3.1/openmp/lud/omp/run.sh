...
clang -fopenmp -fopenmp-targets=nvptx64 -L/home/shmmohammed/projects/cost-model/opt/llvm/lib -Xopenmp-target -march=sm_75 -o lud_omp lud.o lud_omp.o ../common/common.o -lm  -DOMP_OFFLOAD
